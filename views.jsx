    ...
    <article className="card post lift">
      ...
      {post.image && (
        <div style={{ padding: '4px 20px 12px' }}>
          <img src={post.image} className="post-image" alt="" style={{ borderRadius: 12, border: '1px solid var(--hairline)' }} />
        </div>
      )}
  ...
  return (
    <div className="view-fade">
      ...
      <div style={{ maxWidth: 880, margin: '0 auto', padding: '0 28px 48px' }}>
        <div style={{ display: 'flex', alignItems: 'flex-end', gap: 18, marginTop: -56 }}>
          <img src={ME.avatar} className="avatar avatar--xl" alt="" />
...
function ClubView({ id, go }) {
  ...
  return (
    <div className="view-fade">
      ...
      <div style={{ maxWidth: 880, margin: '0 auto', padding: '0 28px 48px' }}>
        <div style={{ display: 'flex', alignItems: 'flex-end', gap: 18, marginTop: -56 }}>
          <img src={c.avatar} className="avatar avatar--xl" alt="" />
          <div style={{ flex: 1, paddingBottom: 10 }}>
            <h2 className="serif" style={{ margin: 0, fontSize: 30, color: 'var(--ink)', display: 'flex', alignItems: 'center', gap: 8 }}>
              {c.name} {c.verified && <VerifiedDot />}
            </h2>
        ...
        {tab === 'members' && (
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(180px, 1fr))', gap: 12, marginTop: 18 }}>
            {[
              ...
              { name: 'sarah_k', role: 'VP', avatar: 'assets/avatar-23.png' },
              { name: 'rae.m',   role: 'Treasurer', avatar: 'assets/avatar-11.png' },
